                  ...
                  <tr>
                    ...
                    >
                      <div className="flex flex-col space-y-1 md:flex-row md:space-x-1 md:space-y-0">
                        <button onClick={sortByRatingIncreasing}>
                          <IoCaretUpCircleOutline size="20px" />
                        </button>
                        <div>Rating</div>
                        <button onClick={sortByRatingDecreasing}>
                    ...
                    >
                      <div className="flex flex-col space-y-1 md:flex-row md:space-x-1 md:space-y-0">
                        <button onClick={sortByPopularityIncreasing}>
                          <IoCaretUpCircleOutline size="20px" />
                        </button>
                        <div>Popularity</div>
                        <button onClick={sortByPopularityDecreasing}>
                          <IoCaretDownCircleOutline size="20px" />
                        </button>
                      </div>
                    </th>
                      ...
                      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                        <span className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                          ...
                          <span className="relative">
                            {allGenres[fav.genre_ids[0]]}
                          </span>
                        </span>
                      </td>
                      <td className="px-5 py-5 text-center border-b border-gray-200 bg-white text-sm">
                        <button
                          onClick={() => deleteMovie(fav.id)}
